...
contract("StakingRewardMinAmountFixedAPY", (accounts) => {
  ...
  beforeEach(async function () {
    this.contract = await StakingRewardMinAmountFixedAPY.new(
      this.rewardToken.address,
      this.stakingToken.address,
      _rewardRate,
      this.router.address,
  ...
  describe("stake", function () {
    it("reject when amount less than min stake", async function () {
      ...
      await expectRevert(
        ...
        "StakingRewardMinAmountFixedAPY: Amount is less than min stake"
      );
    });
    ...
    it("reject stake zero value", async function () {
      await expectRevert(
        ...
        "StakingRewardMinAmountFixedAPY: Cannot stake 0"
      );
    });
  ...
  describe("withdraw", function () {
    ...
    it("doesn't stake before", async function () {
      await expectRevert(
        ...
        "StakingRewardMinAmountFixedAPY: This stake nonce was withdrawn"
      );
    });
      ...
      describe("rescue token", function () {
        it("zero address", async function () {
          await expectRevert(
            ...
            "StakingRewardMinAmountFixedAPY: Cannot rescue to the zero address"
          );
        });
        ...
        it("zero amount", async function () {
          await expectRevert(
            ...
            "StakingRewardMinAmountFixedAPY: Cannot rescue 0"
          );
        });
        ...
        it("staking token", async function () {
          await expectRevert(
            ...
            "StakingRewardMinAmountFixedAPY: Cannot rescue staking token"
          );
        });
