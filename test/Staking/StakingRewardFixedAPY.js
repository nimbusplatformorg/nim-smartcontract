...
contract("StakingRewardFixedAPY", (accounts) => {
  ...
  beforeEach(async function () {
    this.contract = await StakingRewardFixedAPY.new(
      this.rewardToken.address,
      this.stakingToken.address,
      this.router.address,
      _rewardRate
  ...
  describe("stake", function () {
    ...
    it("reject when contract doesnt have allowance token from user", async function () {
      await expectRevert(
        this.contract.stake(stakeValue, {
    ...
    it("reject stake zero value", async function () {
      await expectRevert(
        ...
        "StakingRewardFixedAPY: Cannot stake 0"
      );
    });
      ...
      describe("rescue token", function () {
        ...
        it("zero amount", async function () {
          await expectRevert(
            ...
            "StakingRewardFixedAPY: Cannot rescue 0"
          );
        });
