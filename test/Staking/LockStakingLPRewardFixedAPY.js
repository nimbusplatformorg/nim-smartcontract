...
contract("LockStakingLPRewardFixedAPY", (accounts) => {
  ...
  beforeEach(async function () {
    this.contract = await LockStakingLPRewardFixedAPY.new(
      this.rewardToken.address,
  ...
  describe("stake", function () {
    ...
    it("reject stake zero value", async function () {
      await expectRevert(
        ...
        "LockStakingLPRewardFixedAPY: Cannot stake 0"
      );
    });
  ...
  describe("withdraw", function () {
    ...
    it("doesn't stake before", async function () {
      await expectRevert(
        ...
        "LockStakingLPRewardFixedAPY: This stake nonce was withdrawn"
      );
    });
    ...
    describe("stake before", function () {
      ...
      it("reject when is locked", async function () {
        await expectRevert(
          this.contract.withdraw(0, { from: client }),
          "LockStakingLPRewardFixedAPY: Locked"
        );
      });
      ...
      describe("rescue token", function () {
        it("zero address", async function () {
          await expectRevert(
            ...
            "LockStakingLPRewardFixedAPY: Cannot rescue to the zero address"
          );
        });
        ...
        it("staking token", async function () {
          await expectRevert(
            ...
            "LockStakingLPRewardFixedAPY: Cannot rescue staking token"
          );
        });
