...
contract ProtocolLike {
    ...
    /// @param isProtocolLoan boolean whether it is protocol or non protocol loan
    ...
    ///         loanTokenReceived: total loanToken deposit (amount not sent to borrower in the case of protocol loans)
    ///         collateralTokenReceived: total collateralToken deposit
    /// @param loanDataBytes required when sending BNB
